# See billing_scenarios_eu_west_2.ods for details
...
Feature: Test AWS RDS bills calculated correctly
  ...
  Then the bill, including VAT, should be £4.58
...
####
  ...
  Then the bill, including VAT, should be £4413.91
...
####
  ...
  Then the bill, including VAT, should be £564.58
