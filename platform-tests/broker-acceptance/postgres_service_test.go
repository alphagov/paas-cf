...
var _ = Describe("Postgres backing service", func() {
	...
	It("has only the expected plans available to the user", func() {
		workflowhelpers.AsUser(testContext.RegularUserContext(), testContext.ShortTimeout(), func() {
			...
			Expect(cfMarketplaceOutput).To(ContainSubstring("large-10-deprecated"))
			Expect(cfMarketplaceOutput).To(ContainSubstring("large-ha-10"))
			Expect(cfMarketplaceOutput).To(ContainSubstring("large-ha-10-deprecated"))
			...
			Expect(cfMarketplaceOutput).To(ContainSubstring("large-11-deprecated"))
			Expect(cfMarketplaceOutput).To(ContainSubstring("large-ha-11"))
			Expect(cfMarketplaceOutput).To(ContainSubstring("large-ha-11-deprecated"))
			...
			Expect(cfMarketplaceOutput).To(ContainSubstring("large-ha-12-deprecated"))
