RSpec.describe "SQS broker properties" do
  let(:manifest) { manifest_with_defaults }
  let(:properties) { manifest.fetch("instance_groups.sqs_broker.jobs.sqs-broker.properties.sqs-broker") }
  ...
  describe "service broker is set to be shareable" do
    ...
    it "each service of the aws sqs service broker is shareable" do
