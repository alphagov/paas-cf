...
cronitor_ping_api_key = ENV["CRONITOR_PING_API_KEY"] || get_secret("cronitor/#{ENV['MAKEFILE_ENV_TARGET']}/ping_api_key", "__NO_CRONITOR_PING_API_KEY__")

upload_secrets(
  credhub_namespaces,
  "cronitor_ping_api_key" => cronitor_ping_api_key,
)
