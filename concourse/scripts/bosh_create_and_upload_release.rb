...
def check_release(name, version)
  ...
  unless this_release.nil? or this_release.empty?
...
if ARGV.size != 3 or release_name == '' or release_version == '' or release_dir == ''
  usage
end
...
unless this_release_version.nil? or this_release_version.empty?
