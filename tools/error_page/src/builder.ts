...
render(ErrorPage(), { title: '{{ .StatusText }}' })
  .then(value => {
    process.stdout.write('# WARNING HUMAN!\n');
    process.stdout.write('# This file has been autogenerated!\n');
    process.stdout.write('# See paas-cf/tools/error_page/README.md for details.\n');
